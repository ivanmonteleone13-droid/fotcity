...
function Stars({ rating }: { rating: number }) {
  return (
    <div className="flex gap-0.5 text-[#95D5B2]" aria-label={`${rating} av 5 stjärnor`}>
...
export default function ReviewsCarousel() {
  ...
  return (
    <section id="omdomen" className="bg-[#2D6A4F] py-20 text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-sm font-semibold uppercase tracking-wider text-[#95D5B2]">Omdömen</p>
        ...
        <div className="mt-10 text-center">
          <a
            ...
            className="inline-flex items-center justify-center rounded-full bg-[#95D5B2] px-8 py-3 text-sm font-semibold text-[#1B4332] transition hover:opacity-90"
          >
